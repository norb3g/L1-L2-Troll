...
/* Library Imports */
import {
    ExtendedAbs_L2DepositedToken
} from "./ExtendedAbs_L2DepositedToken.sol";
 ...
 * Runtime target: OVM
 */
contract ExtendedL2DepositedERC20 is ExtendedAbs_L2DepositedToken, ERC20 {
    ...
    constructor(
        ...
        ExtendedAbs_L2DepositedToken(_l2CrossDomainMessenger)
        ERC20(0, _name)
    {}
